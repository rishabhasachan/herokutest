<%-- 
    Document   : sql2
    Created on : Jun 26, 2017, 5:51:14 AM
...
<div class="container">
	...
	<div class="row jumbotron" style="margin:15px; padding:15px;align:center" >
			...
			<div id="div" style="width:100%;height:16%;">
				...
				<div class="div1 " style="float:left"><h2>T</h2></div><span id="div11" class="fa" style="float:right;"></span>	
			</div>								
			</div>	
	        </div>
                          ...
                          <%  
                            ...
                            nameD="answer";
                                ...
                                %> <center>
                                    ...
                                    <button type="submit" class="btn btn-primary" id="btnauto" style="width: 100px;" name="noq" value="<%= i %>">Submit</button>
                                    </center>
