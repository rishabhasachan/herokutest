...
<!--	<ul class="nav navbar-nav font5">
		<li><a href="admin.jsp"><span class="glyphicon glyphicon-home"></span> <b>AdminHome</b></a></li>
		<li><a href=""><span class="glyphicon glyphicon-tasks"></span> About</a></li>
		<li><a href=""><span class="glyphicon glyphicon-pencil"></span> News</a></li>
                ...
                <table>  
                    <tr class="font5">
                        ...
                        <td><%  
                            ...
                            if(admin==null){
                %><span style="margin-right:20px;"><%out.print("Admin not logged in"); response.sendRedirect("adminlogin.jsp");  %></span><% 
                            %></span><% 
                            %>
                        </td>
			<td><ul class="nav navbar-nav">
                            <li> <a href="index.jsp"  style="color:white;"><button  style="width:100px; background-color: #4CAF50;color: white; padding: 10px 10px;
