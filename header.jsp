...
<body style="background-color:#6bbaa7;background-image: url(i/3.jpg) ;background-size:cover;
...
<div class="container-fluid" >
   ...
   <a href="contact.jsp"> <button class="btn info"id="btn">Contact</button></a>
	...
	<!--<ul class="nav navbar-nav font5">
		...
		<li><a href="about.jsp"><span class="glyphicon glyphicon-tasks"></span> About</a></li>
		<li><a href="news.jsp"><span class="glyphicon glyphicon-pencil"></span> News</a></li>
		<li><a href="contact.jsp"><span class="glyphicon glyphicon-earphone"></span> Contact Us </a></li>
                <li>      </li>      
                 </ul> --> 
...
window.onclick = function(event) {
    if (event.target == modal) {
        ...
        <td> <a href="signup.jsp"  style="color:white;"><button  style="width:100px; background-color: #4CAF50;color: white; padding: 20px 20px;
                 ...
                 <!--     this is is heaser inbuilt    login form which is alternate working form  
                        
			<form action="login.inc.jsp" method="post" >
                            <td ><input type="text" name="uid" placeholder="user id" class="form-control" required=""><br></td>
                            <td style="padding-left:5px;">
                                <input type="password" name="pwd" placeholder="password" class="form-control" required="">
                                <a href="forgotpass.jsp" style="color:pink" >Forget Password?</a>
                            </td>
                            <td style="padding-left:5px;">
				<button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-log-in"></span> Login</button><br>
                                <a href="adminlogin.jsp" style="color:lightblue">Admin Login</a>
                            </td>			
                        </form>					
                        <td> <a href="signup.jsp"  style="color:white;"><h4><b>Sign up <span class="glyphicon glyphicon-user"></span></b></h4></a><br></td>							
