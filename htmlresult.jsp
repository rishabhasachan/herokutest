<%-- 
    Document   : testresult
    Created on : Jun 25, 2017, 1:19:33 AM
...
<html>
    ...
    <body>
        ...
        <%  
            ...
            String nameD="answer";
           //int n=5;
     //    int n= Integer.parseInt(request.getAttribute("noq"));   //number of questions that should acceessed by exams test
         //String n2= (String)session.getAttribute("noq");out.print("noq value in string "+n2);%><br><%
          //  int n = Integer.parseInt(tp);
          //  int n = Integer.getInteger("noq");
          String n2= (String)request.getParameter("noq");
              int n= Integer.parseInt(n2);
               
          //int noq= session.getAttribute("noq");
          //out.print("Number of questions accessed from submit form in string formate are: "+noq);%><br><%
         // int n=Integer.parseInt(noq);
          ...
          %><center><h3><table><td><% out.print("<b>"+"Name: "+"</b>"+fname+" "+lname+"<br>");%></td><td style="padding-left:20px;"><%
                            out.print("<b>"+"Subject:"+"</b>"+ "HTML" ); %></td></table></h3></center><%
                            }
                            ...
                            ResultSet rs= st.executeQuery("select * from test where sub='html'");
                ...
                float per=(number*100)/n;
                 ...
                 //now data is stored in record table 
         ...
         st.execute("insert into record values('"+uname+"','"+d+"','"+num+"','"+mm+"','"+p+"','HTML')");
